    ...
    return (
        <section className={css['minishoot-booking']}>
            ...
            <nav className={css['minishoot-buttons']}>
                ...
                {
                    minishoot && 
                    <div className={css['minishoot-dates']}>
                    {minishoot.map((mini)=>{
                        return (
                        <div key={mini.date}>
