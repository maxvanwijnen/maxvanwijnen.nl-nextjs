...
const MinishootBooking = () => {
    ...
    return (
        <section className={css['minishoot-booking']} id="minishoots">
            ...
            <Image 
              src="https://dev1.maxvanwijnen.nl/docs/images/mini-portfolio/roos-studio-portret-achtergrond-zwart.webp" 
              alt="Voorbeeld van een miniportret shoot in de studio met zwarte achtergrond" 
              width={330} 
              height={450}
              style={{
                maxWidth: '100%',
