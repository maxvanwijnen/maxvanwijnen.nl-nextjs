...
const FotoshootHillegom = () => {
    ...
    return (
        <>
            <Head>
                <title>
                    Fotograaf Hillegom | Professionele Fotoshoot | Max van Wijnen Fotografie
                </title>
                <meta
                    name="description"
                    content="Op zoek naar een professionele fotograaf in Hillegom? De mooiste fotografie voor zwangerschap, familie en portret fotoshoots in de Bollenstreek. Ook aanwezig op top-fotografen.nl"
                    key="desc"
                />
