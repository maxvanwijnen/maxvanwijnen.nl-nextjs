...
export default function Kinderen (){
    return (
        ...
        <Quote>Kinderen groeien zo snel op, maak daarom tijd om hun kostbare momenten vast te leggen</Quote>
            <TextContent>
                <h2>Waarom een professionele fotoshoot van uw kinderen?</h2>
                <p>Als ouder wil je altijd de beste herinneringen vastleggen van je kinderen. Een professionele fotoshoot is hiervoor de ideale manier. Met professionele apparatuur en ervaring kan een fotograaf de natuurlijke schoonheid van je kind vastleggen, evenals hun unieke persoonlijkheid. Bovendien biedt een fotoshoot de mogelijkheid om fotos te maken die je misschien niet zelf zou bedenken, waardoor je nog meer unieke fotos krijgt om te koesteren.</p>

                <h2>Voorbereiding op de fotoshoot</h2>
                <p>Het is belangrijk om je kind voor te bereiden op de fotoshoot om het meeste uit de sessie te halen. Hier zijn enkele tips:</p>

                <p>Kies kleding die past bij de persoonlijkheid van je kind en comfortabel zit. Vermijd drukke patronen en grote logos die kunnen afleiden van de fotos.
                    ...
                    <h2>Wat kun je verwachten tijdens de fotoshoot?</h2>
                ...
                <h2>De beste leeftijd voor een kinderfotoshoot</h2>
                <p>Er is geen specifieke leeftijd waarop een kinderfotoshoot het beste is. Elke leeftijd biedt unieke mogelijkheden voor creatieve en unieke fotos. Voor pasgeboren babys worden de beste fotos meestal gemaakt binnen de eerste twee weken na de geboorte. Voor oudere kinderen kunnen we een fotoshoot op maat maken op basis van hun leeftijd en persoonlijkheid.</p>
